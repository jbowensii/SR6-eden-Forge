...
Path = _P                    # the sys.path bootstrap alias, under its usual name
...
if __name__ == "__main__":
    # Guarded because this rewrites the shared gear library and re-extracts
    # 230 PNGs. Without the guard, merely importing the module to look at it
    # ran the whole phase — which is exactly how it got run by accident.
    DATA = Path("data")
